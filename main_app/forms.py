...
class StudentForm(forms.Form):
    USER_TYPE = (
        ...
        ('تحقیقات و خدمات کشاورزی و بهزراعی آذربایجان غربی', 'تحقیقات و خدمات کشاورزی و بهزراعی آذربایجان غربی'),  # اضافه کردن نوع کاربر جدید
        ('تحقیقات و خدمات فنی مکانیزه چغندر قند ارومیه', 'تحقیقات و خدمات فنی مکانیزه چغندر قند ارومیه'),  # اضافه کردن نوع کاربر جدید
    )
    ...
    company = forms.ChoiceField(choices=USER_TYPE, label="نام شرکت را وارد کنید")
    ...
    jalali_date = forms.ChoiceField(choices=JALALI_DATE,label="ماه و سال شمسی را وارد کنید")
    file = forms.FileField(label="فایل را وارد کنید")
